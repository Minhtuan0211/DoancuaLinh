...
const handle99 = () => {
  ...
  localStorage.setItem("productsIs99", JSON.stringify(productsLocal));
...
const handle64GB = () => {
  ...
  localStorage.setItem("productsIs64", JSON.stringify(productsLocal));
...
const renderOrderstManagementPage = () => {
  ...
  console.log(data);
  // Lặp qua từng người dùng trong mảng data
